...
for i in {1..10}; do
    docker run -d -v `pwd`:`pwd` -w `pwd` \
        ...
        --matrix-path ./data/tm-full/Heart_and_Aorta-10X_P7_4 \
        --matrix-path ./data/tm-full/Kidney-10X_P4_5 \
        --matrix-path ./data/tm-full/Kidney-10X_P4_6 \
        --matrix-path ./data/tm-full/Kidney-10X_P7_5 \
        --matrix-path ./data/tm-full/Limb_Muscle-10X_P7_14 \
        --matrix-path ./data/tm-full/Limb_Muscle-10X_P7_15 \
        --matrix-path ./data/tm-full/Liver-10X_P4_2 \
        --matrix-path ./data/tm-full/Liver-10X_P7_0 \
        --matrix-path ./data/tm-full/Liver-10X_P7_1 \
        --matrix-path ./data/tm-full/Lung-10X_P7_8 \
        --matrix-path ./data/tm-full/Lung-10X_P7_9 \
        --matrix-path ./data/tm-full/Mammary_Gland-10X_P7_12 \
        --matrix-path ./data/tm-full/Mammary_Gland-10X_P7_13 \
        --matrix-path ./data/tm-full/Marrow-10X_P7_2 \
        --matrix-path ./data/tm-full/Marrow-10X_P7_3 \
        --matrix-path ./data/tm-full/Spleen-10X_P4_7 \
        --matrix-path ./data/tm-full/Spleen-10X_P7_6 \
        --matrix-path ./data/tm-full/Thymus-10X_P7_11 \
